...
ShowCue v22: Cue Pad controls rebuilt using direct native inline iPad touch/click handlers. The pencil editor is a separate native button and is no longer dependent on delegated document click handling or an overlapping full-pad launch button.
